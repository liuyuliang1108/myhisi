    ...
    public function add($pid = '', $mod = '')
    {
        if ($this->request->isPost()) {
            ...
            if (strtolower($url) != 'system/plugins/run') {
                ...
                //并清除缓存
                Cache::rm($this->config['prefix']."breadCrumbs_".$result->id);
                Cache::rm($this->config['prefix']."menuParents_".$result->id);
                Cache::rm($this->config['prefix']."mainMenu");
    ...
    public function edit()
    {
        ...
        if ($this->request->isPost()) {
            ...
            if (strtolower($url) != 'system/plugins/run') {
                ...
                $this->export($pid, false);
                //并清除缓存
                Cache::rm($this->config['prefix']."breadCrumbs_".$id);
                Cache::rm($this->config['prefix']."menuParents_".$id);
                Cache::rm($this->config['prefix']."mainMenu");
            }
